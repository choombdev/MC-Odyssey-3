...
onEvent('recipes', event => {
  // , 'apotheosis:uncommon_material', 'apotheosis:rare_material', 'apotheosis:epic_material', 'apotheosis:mythic_material'
  ...
  // Rare Material
  event.recipes.botania.runic_altar('apotheosis:rare_material', ['apotheosis:uncommon_material','apotheosis:common_material', 'arsarsenal:source_steel_ingot'], 5000)
  // Epic Material
